...
public class SearchOrderFormController {
    ...
    public void OrderIdOnAction(ActionEvent actionEvent){
        ...
        try {
            ...
            ArrayList<SearchOrderAddTblDTO> dtolist = queryDAO.addTable(id);

            for (SearchOrderAddTblDTO c : dtolist) {
                lblId.setText(c.getOrderId());
    ...
    public void cusIdOnAction(ActionEvent actionEvent) {
        ...
        try {
            ArrayList<SearchOrderByCustomerDTO> dtolist = queryDAO.searchOrder(id);

            for (SearchOrderByCustomerDTO c : dtolist) {
                cmbOrderId.getItems().add(c.getOrderId());
